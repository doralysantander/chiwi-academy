...
<form action="{{route('event.update', $masterClass )}}" method="POST">
    @csrf
    @method('PUT')
    ...
    <div>
        <div class="flex -mx-3">
            ...
            <div class="w-1/2 px-3 mb-5">
                ...
                <input name="title" type="text" placeholder="Titulo" value="{{old('title', $masterClass->title)}}"
            ...
            <div class="w-1/2 px-3 mb-5">
                ...
                <input name="fecha" type="date" placeholder="Fecha" value="{{old('fecha', $masterClass->fecha)}}"
                class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-orange-600">
                @error('fecha')
                    <br>
                    <small>*{{$message}}</small>
            ...
            <div class="w-1/2 px-3 mb-5">
                ...
                <input name="hora" type="time" placeholder="Hora" value="{{old('hora', $masterClass->hora)}}"
                class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-orange-600">
                @error('hora')
                    <br>
                    <small>*{{$message}}</small>
        ...
        <div class="flex -mx-3">
            <div class="w-full px-3 mb-5">
                ...
                <input name="descripcion" type="text" placeholder="Descripción" value="{{old('descripcion', $masterClass->descripcion)}}"
                class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-orange-600">
                @error('descripcion')
                    <br>
                    <small>*{{$message}}</small>
        ...
        <div class="flex -mx-3">
            <div class="w-full px-3 mb-12">
                ...
                <input name="participantes" type="number" placeholder="Inscritos" value="{{old('participantes', $masterClass->numero_participantes)}}"
                class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-orange-600">
                @error('participantes')
                    <br>
                    <small>*{{$message}}</small>
